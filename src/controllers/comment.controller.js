...
const getVideoComments = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, allComments, "commented successfully"));
});
...
const addComment = asyncHandler(async (req, res) => {
  ...
  if (!videoId || !commentContent)
    throw new ApiError(404, "Id or commentContent not found");
...
const deleteComment = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, comment, "comment remove successfully"));
});
